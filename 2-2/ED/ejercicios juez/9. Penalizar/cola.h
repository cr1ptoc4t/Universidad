...
USUARIO DEL JUEZ DOMJUDGE: ED50 
 */
...
public:
	...
	* 
	* O(n+m+N), donde n es el número de elementos antes de la secuencia a penalizar,
	* m es el número de elementos en la secuencia a penalizar y 
	* N es el número total de elementos en la cola original
	* 
	* podriamos resumir que es O(n)
	*/
