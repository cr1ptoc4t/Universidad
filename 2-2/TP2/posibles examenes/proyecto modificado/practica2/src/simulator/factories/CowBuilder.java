...
import simulator.model.animals.Cow;
...
public class CowBuilder extends Builder {
    Factory<SelectionStrategy>  _sel;

    public CowBuilder(Factory<SelectionStrategy> sel) {
        super("cow", "Animal");
    ...
    @Override
    public Cow create_instance(JSONObject data) {
        Vector2D posicion;
        ...
        return new Cow(mateStrategy, dangerStrategy, posicion);
    }
