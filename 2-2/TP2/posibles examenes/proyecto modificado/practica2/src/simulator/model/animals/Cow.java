...
public class Cow extends Animal{
    ...
    public Cow(SelectionStrategy mate_strategy, SelectionStrategy danger_strategy,
                 Vector2D pos){
        super("COW",  Diet.HERBIVORE , SIGHT_RANGE, INIT_SPEED, mate_strategy, pos);
    ...
    private void avanzar(double dt){
        ...
        actualyzeAgeEnergyDesire(dt, -dt*20, dt*70,
    ...
    private void emparejarse(){
        ...
        if (!is_pregnant()&& !_mate_target.is_pregnant() && Utils._rand.nextDouble() < 0.9)
            _baby = new Cow(this, _mate_target);
